...
A full-stack **Smart Library Management System** built using the **MERN Stack (MongoDB, Express.js, React.js, Node.js,TailwindCSS)** to simplify and automate library operations. The application provides a modern, secure, and user-friendly platform for managing books, members, borrowing, returns, reservations, and overdue fines through a role-based dashboard.
